'''
This bot sends notam images separately from the notam message.
I'm keeping it just in case, the main NOTAMcheckbot script where
...
from today_notam_G import notams_by_day  # Importing notams_by_day from today_notam_G.py
